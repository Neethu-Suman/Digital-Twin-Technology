...
```
         ...
         v                            v                            v
+------------------+         +------------------+         +------------------+
|  Physics-Based   |         |   Data-Driven    |         |   Hybrid Twin    |
| (First Principles|         |   (Machine Learning|         | (Physics + AI/ML)|
| & CAD/FEA/CFD)   |         |   & Deep Learning) |         |  Combines Both)  |
+------------------+         +------------------+         +------------------+
